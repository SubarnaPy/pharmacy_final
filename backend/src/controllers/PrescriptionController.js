...
//     console.log('✅ Advanced Prescription Controller initialized');
//   }
...
//     try {
//       console.log('📋 Processing single prescription request');
...
//           console.log('📸 Using converted image for OCR:', processedFilePath);
//         }
//       }
...
//     } catch (error) {
//       console.error('❌ Single prescription processing failed:', error.message);
...
//     try {
//       console.log('📋 Processing prescription and creating pharmacy request');
...
//       console.log('⚙️ Processing prescription with options:', options);
...
//         doctor: result.ai?.geminiResults?.analysis?.prescriberInfo || {},
//         patientInfo: result.ai?.geminiResults?.analysis?.patientInfo || {},
...
//     } catch (error) {
//       console.error('❌ Prescription processing and request creation failed:', error.message);
...
//       console.log(`📤 Submitting prescription request ${requestId} to pharmacies`);
...
//     try {
//       console.log(`📦 Processing batch prescription request with ${req.files?.length || 0} files`);
...
//     } catch (error) {
//       console.error('❌ Batch prescription processing failed:', error.message);
...
//     } catch (error) {
//       console.error('❌ Failed to get processing history:', error.message);
//       res.status(500).json({
//         success: false,
...
//     } catch (error) {
//       console.error('❌ Failed to get processing result:', error.message);
//       res.status(500).json({
//         success: false,
...
//     } catch (error) {
//       console.error('❌ Failed to reprocess prescription:', error.message);
//       res.status(500).json({
//         success: false,
...
//     } catch (error) {
//       console.error('❌ Failed to validate prescription:', error.message);
//       res.status(500).json({
//         success: false,
...
//     try {
//                 console.log('   medications in analysis:', result.ai);

//       console.log(`💾 Saving prescription processing result to database...`);
//       console.log('🔍 DEBUG: Full result structure:');
//       console.log('   result.ai exists:', !!result.ai);
//       if (result.ai) {
//         console.log('   result.ai keys:', Object.keys(result.ai));
//         if (result.ai.analysis) {
//           console.log('   result.ai.analysis keys:', Object.keys(result.ai.analysis));
//           console.log('   medications in analysis:', result.ai.analysis.medications?.length || 0);
//         }
//       }
...
//         console.log('🔍 DEBUG: Gemini data structure:');
//         console.log('   geminiData keys:', Object.keys(geminiData));
//         console.log('   geminiResults exists:', !!geminiData.geminiResults);
//         console.log('   medications exists:', !!geminiData.medications);
//         console.log('   parsed exists:', !!geminiData.parsed);
        
//         // NEW: Check direct medications in geminiData
//         if (geminiData.medications && geminiData.medications.medications) {
//           console.log('   Found medications directly in geminiData.medications:', geminiData.medications.medications.length);
//         }
        
//         // OLD: Check for geminiResults structure
//         if (geminiData.geminiResults) {
//           console.log('   geminiResults keys:', Object.keys(geminiData.geminiResults));
//           console.log('   analysis exists:', !!geminiData.geminiResults.analysis);
//           if (geminiData.geminiResults.analysis) {
//             console.log('   analysis keys:', Object.keys(geminiData.geminiResults.analysis));
//             console.log('   medications in analysis:', geminiData.geminiResults.analysis.medications?.length || 0);
//           }
//         }
...
//           console.log('📋 Using NEW structure: geminiData.medications.medications');
...
//           console.log('📋 Using PARSED structure: geminiData.parsed.medications');
...
//           console.log('📋 Using OLD structure: geminiData.geminiResults.analysis.medications');
//           extractedMedications = geminiData.geminiResults.analysis.medications;
//         }
//         else {
//           console.log('⚠️ No medications found in any expected path');
//           console.log('🔍 Available paths:');
//           console.log('   - geminiData.medications?.medications:', !!geminiData.medications?.medications);
//           console.log('   - geminiData.parsed?.medications:', !!geminiData.parsed?.medications);
//           console.log('   - geminiData.geminiResults?.analysis?.medications:', !!geminiData.geminiResults?.analysis?.medications);
//         }
        
//         if (extractedMedications.length > 0) {
//           console.log(`✅ Found ${extractedMedications.length} medications in Gemini data`);
...
//           })));
//         } else {
//           console.log('⚠️ No medications found in any expected path - trying additional fallback paths');
...
//             console.log('📋 Found medications in enhancedAnalysis.geminiAnalysis.medications:', geminiData.enhancedAnalysis.geminiAnalysis.medications.length);
...
//             console.log('📋 Found medications at root level:', geminiData.medications.length);
...
//           console.log('🚨 DEBUG: Processing risk assessment data:', {
//             riskLevel: riskData.riskLevel,
//             riskFactorsCount: riskData.riskFactors?.length || 0,
//             warningsCount: riskData.warnings?.length || 0,
//             recommendationsType: typeof riskData.recommendations,
//             recommendationsCount: Array.isArray(riskData.recommendations) ? riskData.recommendations.length : 0
//           });
//           riskAssessment = {
...
//           console.log('🚨 DEBUG: Processing risk assessment from alternative path:', {
//             riskLevel: riskData.riskLevel,
//             riskFactorsCount: riskData.riskFactors?.length || 0,
//             warningsCount: riskData.warnings?.length || 0,
//             recommendationsType: typeof riskData.recommendations,
...
//         else {
//           console.log('🚨 DEBUG: No risk assessment found, using defaults');
//           riskAssessment = {
//             riskLevel: 'moderate',
//             riskFactors: [],
//             warnings: [],
...
//       console.log('✅ Prescription processing result saved to database');
...
//           console.log(`         - Confidence: ${(med.confidence * 100).toFixed(1)}%`);
//         });
//       }
      
//       console.log(`   👤 Patient: ${patientInfo.name || 'Not specified'}`);
//       console.log(`   👨‍⚕️ Doctor: ${doctorInfo.name || 'Not specified'}`);
//       console.log(`   ⚠️ Drug interactions: ${drugInteractions.length}`);
//       console.log(`   🚨 Risk level: ${riskAssessment.riskLevel || 'Unknown'}`);
//       console.log(`   🎯 Overall confidence: ${(prescriptionData.aiProcessing.overallConfidence * 100).toFixed(1)}%`);
      
//       return savedPrescription;
      
//     } catch (error) {
//       console.error('❌ Failed to save prescription processing:', error.message);
...
//     try {
//       console.log(`💾 Saving batch processing result for user ${userId}`);
...
//       console.log('✅ Batch processing result saved');
      
//     } catch (error) {
//       console.error('❌ Failed to save batch processing:', error.message);
//       // Don't throw error as this is not critical for the main operation
//     }
//   }
...
//       console.log('✅ Prescription controller terminated');
//     } catch (error) {
//       console.error('❌ Error terminating prescription controller:', error.message);
//     }
//   }
// }
