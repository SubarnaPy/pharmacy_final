...
async function checkUsers() {
  try {
    ...
    // Also check for the specific ObjectId we see in the logs
    const userById = await User.findById('688b92ead99cdb72d8b85adb');
    if (userById) {
      console.log('\n✅ Found user by ObjectId 688b92ead99cdb72d8b85adb:');
      console.log(`- Email: ${userById.email}`);
    } else {
      console.log('\n❌ User with ID 688b92ead99cdb72d8b85adb not found');
    }
