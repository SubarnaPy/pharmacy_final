...
function TransactionDashboard() {
  ...
  const fetchTransactions = async () => {
    setLoading(true);
    try {
      console.log('🔍 Fetching pharmacy transactions...');
  ...
  const fetchAnalytics = async () => {
    try {
      console.log('🔍 Fetching pharmacy analytics...');
      ...
      // Keep existing analytics state if API fails
    }
  };
              ...
              {transactions.map((transaction) => (
                <tr key={transaction._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {transaction.patient.contact.email}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button
                      ...
                      className="flex items-center space-x-1 px-3 py-1.5 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors"
                    >
                      <EyeIcon className="h-4 w-4" />
                      <span>View</span>
                    </button>
